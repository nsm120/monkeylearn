...
In our case, it's certainly made frequent communication the path of least resistance. Despite the time difference and `r emo::ji("baby")`(!), communication hasn't been an issue for us at all. 
