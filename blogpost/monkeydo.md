...
initial_workaround <- function(df, col, key) {
  ...
  for (i in 1:nrow(df)) {
    ...
    this_classification <- monkeylearn_classify(this_text, key = key) %>% list()
...
texts                                                                                                                                                                                                tags                                                                                                                                                                                                                                                                           
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
In a hole in the ground there lived a hobbit.                                                                                                                                                        18313280, 18313502, 18313524, 0.071, 0.054, 0.553, Music, Music DVD's, See All Music DVDs, b48a6fe941a1bafee6af3b43a0467bbe, b48a6fe941a1bafee6af3b43a0467bbe, b48a6fe941a1bafee6af3b43a0467bbe                                                                                
It is a truth universally acknowledged, that a single man in possession of a good fortune, must be in want of a wife.                                                                                18314767, 18314954, 18314957, 0.062, 0.047, 0.102, Books, Mystery & Suspense, Police Procedural, af55421029d7236ca6ecbb2819e18137, af55421029d7236ca6ecbb2819e18137, af55421029d7236ca6ecbb2819e18137                                                                          
When Mr. Bilbo Baggins of Bag End announced that he would shortly be celebrating his eleventy-first birthday with a party of special magnificence, there was much talk and excitement in Hobbiton.   18313210, 18313231, 18313235, 18313236, 0.082, 0.176, 0.134, 0.406, Party & Occasions, Party Supplies , Party Decorations, Decorations, 602f1ab2654b88f5c7f5c90e42d1ca7a, 602f1ab2654b88f5c7f5c90e42d1ca7a, 602f1ab2654b88f5c7f5c90e42d1ca7a, 602f1ab2654b88f5c7f5c90e42d1ca7a 
...
texts                                                                                                                                                                                                 category_id   probability  label                text_md5                         
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  ------------  ------------  -------------------  ---------------------------------
In a hole in the ground there lived a hobbit.                                                                                                                                                            18313280         0.071  Music                b48a6fe941a1bafee6af3b43a0467bbe 
In a hole in the ground there lived a hobbit.                                                                                                                                                            18313502         0.054  Music DVD's          b48a6fe941a1bafee6af3b43a0467bbe 
In a hole in the ground there lived a hobbit.                                                                                                                                                            18313524         0.553  See All Music DVDs   b48a6fe941a1bafee6af3b43a0467bbe 
It is a truth universally acknowledged, that a single man in possession of a good fortune, must be in want of a wife.                                                                                    18314767         0.062  Books                af55421029d7236ca6ecbb2819e18137 
It is a truth universally acknowledged, that a single man in possession of a good fortune, must be in want of a wife.                                                                                    18314954         0.047  Mystery & Suspense   af55421029d7236ca6ecbb2819e18137 
It is a truth universally acknowledged, that a single man in possession of a good fortune, must be in want of a wife.                                                                                    18314957         0.102  Police Procedural    af55421029d7236ca6ecbb2819e18137 
When Mr. Bilbo Baggins of Bag End announced that he would shortly be celebrating his eleventy-first birthday with a party of special magnificence, there was much talk and excitement in Hobbiton.       18313210         0.082  Party & Occasions    602f1ab2654b88f5c7f5c90e42d1ca7a 
When Mr. Bilbo Baggins of Bag End announced that he would shortly be celebrating his eleventy-first birthday with a party of special magnificence, there was much talk and excitement in Hobbiton.       18313231         0.176  Party Supplies       602f1ab2654b88f5c7f5c90e42d1ca7a 
When Mr. Bilbo Baggins of Bag End announced that he would shortly be celebrating his eleventy-first birthday with a party of special magnificence, there was much talk and excitement in Hobbiton.       18313235         0.134  Party Decorations    602f1ab2654b88f5c7f5c90e42d1ca7a 
When Mr. Bilbo Baggins of Bag End announced that he would shortly be celebrating his eleventy-first birthday with a party of special magnificence, there was much talk and excitement in Hobbiton.       18313236         0.406  Decorations          602f1ab2654b88f5c7f5c90e42d1ca7a 
...
<img src = "./theresgottabeabetterway.gif" style="text-align: center">
...
At this point, I thought that such a function might be useful to some other people using the package so I started writing an analog to `monkeylearn_classify` that could use `monkeylearn_parse_each()` with an eye toward making a pull request.
...
Plumbing through the guts of the package a bit more, I caught a couple minor bugs (things like the remnants of a for loop remaining in what had been revamped into a while loop) and quick wins for improving the package.

After a few more checks I wrote up a quick [pull request](https://github.com/ropensci/monkeylearn/pull/23) and checked list of [package contributors](https://github.com/ropensci/monkeylearn/graphs/contributors) to see if I knew anyone. Far and away the main contributor was [Maëlle Salmon](http://www.masalmon.eu/)! I'd heard of her through the magic of #rstats Twitter and the R-Ladies Global Slack. A minute or two after submitting the PR I headed over to Slack to give her a heads up that a PR would be heading her way.
...
In our case, it's certainly made frequent communication the path of least resistance. Despite the time difference and 👶(!), communication hasn't been an issue for us at all. 
...
[Thomas Lin Pedersen](https://www.data-imaginist.com/) makes a good point:
...
This insight has me thinking that the best approach might be to explicitly name the issue number *and* give a description in the branch title.

In any case, our current system of only referenging the issue number has worked out well for Maëlle and me thus far, but that certainly doesn't mean that our commit history couldn't be more readable by including descriptors as well.
...
So even though the empty string inputs like in row 3, aren't sent to the API, we can see they're still included in the output dataframe and assigned the same column names as all of the other outputs. That means that even if `unnest` is set to FALSE, the output can still be unnested post facto.
...
Is it better to port all changes made to one over to the other with every update? Or is it instead better to work on one function at a time, and, at some checkpoints then batch these changes over to the other function in a big copy-paste job? I've been tending toward the latter but it's seemed a little dangerous to me.

Since there are only two functions to worry about here, creating a function factory to handle them seemed like overkill but might technically be the best practice.


### Last thoughts

My work on the monkeylearn package so far has been rewarding to say the least. Maëlle's been a fantastic mentor through and through, providing guidance in at least three languages -- English, [French](https://twitter.com/ma_salmon/status/971992354763649024), and R. I couldn't be more stoked for future collaborations. *On y va*!

<img src = "./onward.gif" style="text-align: center">
